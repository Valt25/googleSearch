...
Also I have copied and modified code from next [github repository](https://github.com/spyrant/boolean-retrieval-engine). I used part of this code for parsing boolean retrieval queries.